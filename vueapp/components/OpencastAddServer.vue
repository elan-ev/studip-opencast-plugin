<template>
    <div class="oc--admin--server-card" @click="$router.push({ name: 'add_server'})">
        <div class="oc--admin--server-image">
            ...
            <span class="oc--admin--server-id">
                +
            </span>
        </div>
        <div class="oc--admin--server-data oc--admin-server-add" v-translate>
