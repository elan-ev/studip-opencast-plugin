<?php
// UOL Special
//require_once __DIR__ .'/../cronjobs/refresh_scheduled_events.php';
...
class CronjobRefreshScheduledEvents extends Migration
{
    ...
    public function up()
    {
        RefreshScheduledEvents::register()->schedulePeriodic(-360)->activate();
    }

    public function down()
    {
        RefreshScheduledEvents::unregister();
    }
    */
}