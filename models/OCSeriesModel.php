...
class OCSeriesModel {
    ...
    {
        // Patch "Semester anh�ngen": Hier wird das Semester zu der Veranstaltung ermittelt
        ...
        $data = array(
        // Patch "Semester anh�ngen": Hier wird das Semester an den Namen der Serie geh�ngt
            'title' => $name." ".$sem,
        //  'title' => $name,
        // Patch "Semester anh�ngen: Ende
            'creator' => $creator,
